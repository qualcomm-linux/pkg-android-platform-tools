# Contributing to Overlay Packaging repository for adbd
...
Development happens on distro-specific branches. 
...
1. [Fork](https://github.com/qualcomm-linux/pkg-android-platform-tools/fork) or clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-android-platform-tools.git
    ```

1. Create a new branch based on distro:

    ```bash
    git checkout -b qcom/debian/trixie
    ```

1. Create an upstream `remote` to make it easier to keep your branches up-to-date:

    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-android-platform-tools.git
    ```
...
1. After committing your changes on the distro specific branch, sync it with the
   upstream branch:
    ...
    ```bash
    git pull --rebase upstream qcom/debian/trixie
    ```

1. Push to your fork.

    ```bash
    git push -u origin qcom/debian/trixie
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-android-platform-tools/pulls) from your
